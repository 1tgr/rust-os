...
pub type cairo_destroy_func_t = ::core::option::Option<extern "C" fn(data: *mut ::libc::c_void) -> ()>;
#[repr(C)]
#[derive(Copy)]
...
pub type cairo_write_func_t = ::core::option::Option<
    extern "C" fn(closure: *mut ::libc::c_void, data: *const ::libc::c_uchar, length: ::libc::c_uint) -> cairo_status_t,
>;
pub type cairo_read_func_t = ::core::option::Option<
    extern "C" fn(closure: *mut ::libc::c_void, data: *mut ::libc::c_uchar, length: ::libc::c_uint) -> cairo_status_t,
>;
#[repr(C)]
#[derive(Copy)]
...
pub type cairo_surface_observer_callback_t = ::core::option::Option<
    extern "C" fn(observer: *mut cairo_surface_t, target: *mut cairo_surface_t, data: *mut ::libc::c_void) -> (),
>;
...
pub type cairo_raster_source_snapshot_func_t = ::core::option::Option<
    extern "C" fn(pattern: *mut cairo_pattern_t, callback_data: *mut ::libc::c_void) -> cairo_status_t,
>;
...
pub type cairo_raster_source_finish_func_t =
    ::core::option::Option<extern "C" fn(pattern: *mut cairo_pattern_t, callback_data: *mut ::libc::c_void) -> ()>;
...
extern "C" {
    ...
    pub fn cairo_translate(cr: *mut cairo_t, tx: ::libc::c_double, ty: ::libc::c_double) -> ();
    pub fn cairo_scale(cr: *mut cairo_t, sx: ::libc::c_double, sy: ::libc::c_double) -> ();
    ...
    pub fn cairo_user_to_device(cr: *mut cairo_t, x: *mut ::libc::c_double, y: *mut ::libc::c_double) -> ();
    pub fn cairo_user_to_device_distance(cr: *mut cairo_t, dx: *mut ::libc::c_double, dy: *mut ::libc::c_double) -> ();
    pub fn cairo_device_to_user(cr: *mut cairo_t, x: *mut ::libc::c_double, y: *mut ::libc::c_double) -> ();
    pub fn cairo_device_to_user_distance(cr: *mut cairo_t, dx: *mut ::libc::c_double, dy: *mut ::libc::c_double) -> ();
    ...
    pub fn cairo_rel_move_to(cr: *mut cairo_t, dx: ::libc::c_double, dy: ::libc::c_double) -> ();
    ...
    pub fn cairo_in_stroke(cr: *mut cairo_t, x: ::libc::c_double, y: ::libc::c_double) -> cairo_bool_t;
    pub fn cairo_in_fill(cr: *mut cairo_t, x: ::libc::c_double, y: ::libc::c_double) -> cairo_bool_t;
    pub fn cairo_in_clip(cr: *mut cairo_t, x: ::libc::c_double, y: ::libc::c_double) -> cairo_bool_t;
    ...
    pub fn cairo_get_current_point(cr: *mut cairo_t, x: *mut ::libc::c_double, y: *mut ::libc::c_double) -> ();
    ...
    pub fn cairo_get_dash(cr: *mut cairo_t, dashes: *mut ::libc::c_double, offset: *mut ::libc::c_double) -> ();
    ...
    pub fn cairo_surface_observer_elapsed(surface: *mut cairo_surface_t) -> ::libc::c_double;
    pub fn cairo_device_observer_print(
        device: *mut cairo_device_t,
        write_func: cairo_write_func_t,
        closure: *mut ::libc::c_void,
    ) -> cairo_status_t;
    pub fn cairo_device_observer_elapsed(device: *mut cairo_device_t) -> ::libc::c_double;
    pub fn cairo_device_observer_paint_elapsed(device: *mut cairo_device_t) -> ::libc::c_double;
    pub fn cairo_device_observer_mask_elapsed(device: *mut cairo_device_t) -> ::libc::c_double;
    pub fn cairo_device_observer_fill_elapsed(device: *mut cairo_device_t) -> ::libc::c_double;
    pub fn cairo_device_observer_stroke_elapsed(device: *mut cairo_device_t) -> ::libc::c_double;
    pub fn cairo_device_observer_glyphs_elapsed(device: *mut cairo_device_t) -> ::libc::c_double;
    ...
    pub fn cairo_surface_get_fallback_resolution(
        surface: *mut cairo_surface_t,
        x_pixels_per_inch: *mut ::libc::c_double,
        y_pixels_per_inch: *mut ::libc::c_double,
    ) -> ();
    ...
    pub fn cairo_mesh_pattern_line_to(pattern: *mut cairo_pattern_t, x: ::libc::c_double, y: ::libc::c_double) -> ();
    pub fn cairo_mesh_pattern_move_to(pattern: *mut cairo_pattern_t, x: ::libc::c_double, y: ::libc::c_double) -> ();
    ...
    pub fn cairo_matrix_init_translate(matrix: *mut cairo_matrix_t, tx: ::libc::c_double, ty: ::libc::c_double) -> ();
    pub fn cairo_matrix_init_scale(matrix: *mut cairo_matrix_t, sx: ::libc::c_double, sy: ::libc::c_double) -> ();
    pub fn cairo_matrix_init_rotate(matrix: *mut cairo_matrix_t, radians: ::libc::c_double) -> ();
    pub fn cairo_matrix_translate(matrix: *mut cairo_matrix_t, tx: ::libc::c_double, ty: ::libc::c_double) -> ();
    pub fn cairo_matrix_scale(matrix: *mut cairo_matrix_t, sx: ::libc::c_double, sy: ::libc::c_double) -> ();
    pub fn cairo_matrix_rotate(matrix: *mut cairo_matrix_t, radians: ::libc::c_double) -> ();
